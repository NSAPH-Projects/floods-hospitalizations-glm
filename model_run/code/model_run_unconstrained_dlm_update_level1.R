...
code.lookup.merged = read.csv('/n/dominici_nsaph_l3/Lab/projects/floods-hospitalizations-glm/medicare_processing/data/CCS_lookup_2015.csv')
#remove column "X" 
...
#excludes fips codes that never have an event (if county never has a 1, they were never exposed to a trop. cyclone)
#excludes fips codes that only have events (if county never has a 0, they were never not exposed to a trop. cyclone)
library(plyr)
