# Figure 5. Percentage change in hospitalization rates with flood exposure by cause of hospitalization,
...
dir.output.model.summary.adjusted = paste0('/n/dominici_nsaph_l3/Lab/projects/floods-hospitalizations-glm/Sensitivity/results_severity1_JUN/level1/unconstrained_dlm/summary/adjusted/')
...
pdf(paste0(output.folder,'figure_5_JUN.pdf'),paper='a4r',width=0,height=0)
ggplot() +
