...
USA_DFO <- readRDS("USA_DFO_2000_2018.rds")
USA_table <- readRDS("USA_table_2000_2018.rds")
...
aggregate_measures <- function(id, properties_table, floodwater_info, iso_floodwater, iso_floodwater_dur, polygons){
  ...
  zipcodes_years <- case_when(
    zipcodes_years %in% c("2000","2001","2002","2003") ~ "2000",
    zipcodes_years %in% c("2004") ~ "2004",
    zipcodes_years %in% c("2005") ~ "2005",
    zipcodes_years %in% c("2006") ~ "2006",
    zipcodes_years %in% c("2007","2008") ~ "2007",
    zipcodes_years %in% c("2009") ~ "2009",
    zipcodes_years %in% c("2010","2011") ~ "2010",
    zipcodes_years %in% c("2012") ~ "2012",
    zipcodes_years %in% c("2013") ~ "2013",
    zipcodes_years %in% c("2014") ~ "2014",
    zipcodes_years %in% c("2015") ~ "2015",
    zipcodes_years %in% c("2016") ~ "2016",
    zipcodes_years %in% c("2017", "2018") ~ "2017",
...
saveRDS(flood_data, file = 'zipcode_flood_master_2000_2018.rds')
