...
project.folder = c('/n/dominici_nsaph_l3/projects/floods-hospitalizations-glm/medicare_processing/')
...
dat_admissions_sum_total = ddply(dat_admissions_sum_total,.(SSA_STATE_CD,SSA_CNTY_CD,YEAR,ADATE,ccs_category),summarise,cases=sum(cases))
...
dir.output = paste0('/n/dominici_nsaph_l3/projects/floods-hospitalizations-glm/medicare_processing/data/in_progress/')
