...
dir.input.local = paste0('/n/dominici_nsaph_l3/projects/floods-hospitalizations-glm/medicare_processing/data/in_progress/')
...
state.names = read.csv('/n/dominici_nsaph_l3/projects/floods-hospitalizations-glm/medicare_processing/data/ssa_standard_state_code_lookup.csv')
...
# ssa fips lookup
#Is there a more recent one than 2017? - SA
fips.ssa.lookup = read.csv('/n/dominici_nsaph_l3/projects/floods-hospitalizations-glm/medicare_processing/data/ssa_fips_state_county2017/ssa_fips_state_county2017.csv')
...
#When we switch to zipcodes, we won't remove zipcodes that are not present in all 15+ denominator files because zipcodes change often 
...
dir.output.local = paste0('/n/dominici_nsaph_l3/projects/floods-hospitalizations-glm/medicare_processing/data/')  
