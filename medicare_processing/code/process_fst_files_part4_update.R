...
library(plyr)
dat_denom_sum_total = ddply(dat.all,.(year,zip),summarise,population=sum(population))

# reorder
dat_denom_sum_total = dat_denom_sum_total[order(dat_denom_sum_total$year,dat_denom_sum_total$zip),]
